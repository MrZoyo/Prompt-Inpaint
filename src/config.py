...
class SegmentConfig:
    ...
    # SAM3 model selection (HuggingFace model id or local path)
    sam3_model: str = "facebook/sam3"
    sam3_threshold: float = 0.5  # Detection confidence threshold
    sam3_mask_threshold: float = 0.5  # Mask binarization threshold
    ...
    def from_yaml(cls, yaml_path: str) -> "SegmentConfig":
        ...
        return cls(
            ...
            sam3_model=settings.get("sam3_model", "facebook/sam3"),
            sam3_threshold=settings.get("sam3_threshold", 0.5),
            sam3_mask_threshold=settings.get("sam3_mask_threshold", 0.5),
    ...
    def to_yaml(self, yaml_path: str) -> None:
        ...
        data = {
            ...
            "settings": {
                ...
                "sam3_mask_threshold": self.sam3_mask_threshold,
